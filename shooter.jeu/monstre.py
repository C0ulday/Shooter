...
class Monstre(pygame.sprite.Sprite):
    def __init__(self, monster_type, x, y, speed):
        ...
        if monster_type == "aigle":
            ...
            for i in range(1, 5):
                image_path = f"shooter.jeu/assets/mode1/sprites/aigle/fly{i}.png"
                self.images.append(pygame.image.load(image_path))
            # Images d'animation de mort
            for i in range(1, 7):
                image_path = f"shooter.jeu/assets/mode1/sprites/death/death{i}.png"
            ...
            for i in range(1, 7):
                image_path = f"shooter.jeu/assets/mode1/sprites/frog/jump{i}.png"
                self.images.append(pygame.image.load(image_path))
